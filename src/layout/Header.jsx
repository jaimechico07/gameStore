...
const Header = () => {
  ...
  return (
    <header className="h-[7vh] lg:h-[10vh] text-gray-400 py-4 px-10 flex items-center justify-between z-20">
      {/* Movile */}
      ...
      >
        ...
        <ul className="mt-20">
          ...
          <li>
            <a href="#" className="text-4xl text-[#E58D27] block p-4 text-center">
              Game store
            </a>
          </li>
          <li>
      ...
      <ul className="flex items-center gap-6 text-xl">
        <li>
          <button className="hover:text-[#E58D27] transition-colors" onClick={() => setCartCount(cartCount + 1)}>
            <RiShoppingCartLine />
          </button>
        </li>
        <li>
